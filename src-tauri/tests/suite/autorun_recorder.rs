...
/// claim in this module is taken in this one test, so parallel tests can
/// never see each other's - and the suite's autorun lock keeps the claims
/// other modules take out of it too.
#[tokio::test]

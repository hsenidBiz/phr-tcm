    ...
    let all = serde_json::json!({ "tools": [
        ...
        },
        {
            ...
            "inputSchema": schema(serde_json::json!({
                ...
                "operations": {
                    "type": "array",
                    "description": transform_ops_desc,
                    "items": { "type": "object" },
                },
            }), &["operations"]),
        },
